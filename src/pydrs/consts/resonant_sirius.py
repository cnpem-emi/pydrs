...
list_iib_interlocks = [
    ...
    "Input Overcurrent",
    "Output Overcurrent",
    "Main Board Heat-Sink Overtemperature",
...
bsmp = {
    ...
    "freq_modulated_ff": {"addr": 41, "format": "f", "size": 4, "egu": "Hz"},
    "v_input_iib": {"addr": 42, "format": "f", "size": 4, "egu": "V"},
    "v_output_iib": {"addr": 43, "format": "f", "size": 4, "egu": "V"},
    "i_input_iib": {"addr": 44, "format": "f", "size": 4, "egu": "A"},
    "i_output_iib": {"addr": 45, "format": "f", "size": 4, "egu": "A"},
	"temp_heatsink_main_board_iib": {"addr": 46, "format": "f", "size": 4, "egu": "°C"},
    "temp_heatsink_transformer_iib": {"addr": 47, "format": "f", "size": 4, "egu": "°C"},
    "temp_heatsink_diodes_iib": {"addr": 48, "format": "f", "size": 4, "egu": "°C"},
    "temp_output_inductor_iib": {"addr": 49, "format": "f", "size": 4, "egu": "°C"},
	"v_driver_and_aux_board_iib": {"addr": 50, "format": "f", "size": 4, "egu": "V"},
    "i_driver_iib": {"addr": 51, "format": "f", "size": 4, "egu": "A"},
    "i_aux_board_iib": {"addr": 52, "format": "f", "size": 4, "egu": "A"},
