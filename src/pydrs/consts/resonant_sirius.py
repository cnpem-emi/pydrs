...
bsmp = {
    ...
    "temp_heatsink_transformer_pfc_iib": {"addr": 46, "format": "f", "size": 4, "egu": "°C"},
    "temp_output_inductor_iib": {"addr": 47, "format": "f", "size": 4, "egu": "°C"},
    "temp_heatsink_diodes_iib": {"addr": 48, "format": "f", "size": 4, "egu": "°C"},
    "temp_heatsink_clamp_iib": {"addr": 49, "format": "f", "size": 4, "egu": "°C"},
